export function RightMenu() {
  return (
    <div>
      {/* <button
        data-drawer-target="cta-button-sidebar-2"
        data-drawer-toggle="cta-button-sidebar-2"
        aria-controls="cta-button-sidebar-2"
        type="button"
        ...
        <div className="h-full overflow-y-auto bg-gray-50 px-3 py-4 dark:bg-gray-800">
          ...
          >
            <div className="mb-3 flex items-center">
              ...
              <button
                type="button"
                className="-mx-1.5 -my-1.5 ml-auto inline-flex h-6 h-6 w-6 w-6 items-center justify-center rounded-lg bg-blue-50 p-1 text-blue-900 hover:bg-blue-200 focus:ring-2 focus:ring-blue-400 dark:bg-blue-900 dark:text-blue-400 dark:hover:bg-blue-800"
